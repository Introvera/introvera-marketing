...
const HeroSection: React.FC = () => {
  return (
    <HeroHighlight containerClassName="h-screen">
      <motion.div
        className="flex flex-col items-center justify-center text-center w-full h-full max-w-6xl mx-auto px-4"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8, ease: "easeOut" }}
      >
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-tight text-neutral-800 dark:text-white">
          Innovating Tomorrow,{" "}
        ...
        <p className="mt-6 text-lg sm:text-xl text-neutral-500 dark:text-neutral-300 max-w-3xl">
